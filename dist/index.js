...
var C=require('@stdlib/blas-base-assert-is-layout/dist'),G=require('@stdlib/ndarray-base-assert-is-row-major-string/dist'),p=require('@stdlib/math-base-special-fast-max/dist'),c=require('@stdlib/error-tools-fmtprodmsg/dist'),H=b();function I(i,e,t,l,q,u,g,a){var v,o,f,s,n,r;if(!C(i))throw new TypeError(c('nullFx',i));if(v=G(i),v?r=t:r=e,u<p(1,r))throw new RangeError(c('nullJL',r,u));if(a<p(1,r))throw new RangeError(c('nullGM',r,a));return v?(o=u,f=1,s=a,n=1):(o=1,f=u,s=1,n=a),H(e,t,l,q,o,f,0,g,s,n,0)}y.exports=I
