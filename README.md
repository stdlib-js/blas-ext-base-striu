...
```javascript
striu = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-striu@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var striu = require( 'path/to/vendor/umd/blas-ext-base-striu/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-striu@umd/browser.js"></script>
```
